// messages
#define CONSOLEGREETING		@"Game Server Configulator (Spearhead) greets those who are playing Medal of Honor!"
#define CONSOLE_HEADER		@"MoH:Spearhead server run by Game Server Configulator - Spearhead.\n©2004,2005 P-Edge media - www.p-edge.nl\n\nThe \"Mohaas server executable\" is copyrighted by Aspyr Media inc.\n"
#define CONFIG_HEADER1		@"// Created by Game Server Configulator -Spearhead-]\n// (C) 2003-2006 P-Edge media - www.p-edge.nl\n"
...
#define ABOUT_DISCLAIM          @"The \"mohaas_server\" executable is copyrighted by Aspyr Media inc. and EA Games."
...
#define PRF_GAMEFOLDER2		@"mohaas_server is not here:"
#define PRF_YOUNEEDEXE1         @"Dedicated server executable missing"
#define PRF_YOUNEEDEXE2         @"The dedicated server executable \"mohaas_server\" is not in the selected game folder."
...
#define ALE_NOTEXECUTABLE1	@"mohaas_server is not executable"
...
#define ALE_NOTEXEC_FIXED4      @"Your mohaas_server is now executable."
