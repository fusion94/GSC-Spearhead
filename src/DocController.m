...
// set the default map lists for available maplist AND maprotationlist
{
    ...
    switch ([[gameType selectedItem] tag]) {
        ...
        case 2:
        case 3:
            [aMapArray addObject:@"dm/MP_Bahnhof_DM"];
            [aMapArray addObject:@"dm/MP_Bazaar_DM"];
            [aMapArray addObject:@"dm/MP_Brest_DM"];
            [aMapArray addObject:@"dm/MP_Holland_DM"];
            [aMapArray addObject:@"dm/MP_Stadt_DM"];
            [aMapArray addObject:@"dm/MP_Gewitter_DM"];
            [aMapArray addObject:@"dm/MP_Unterseite_DM"];
            [aMapArray addObject:@"dm/MP_Verschneit_DM"];
			[aMapArray addObject:@"dm/MP_Malta_DM"];
